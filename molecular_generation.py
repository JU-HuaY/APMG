...
from networks.generation import *
from data_pre.ATPG import *
from data_pre.data_preprocess import get_dataset
from data_pre.record import *
from data_pre.data_pre import FOLLOW_BATCH
from data_pre.reconstruct import *
# from data_pre.chem import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--outdir', type=str, default='./outputs/test')
    parser.add_argument('--device', type=str, default='cuda')
    parser.add_argument('-i', '--data_id', type=str, default='17')
    ...
    if config.data.data_name == 'test':
        ...
        # for i in range(100):
        #     print(testset[i].protein_filename)
