...
class PositionPredictor(Module):
    ...
    def forward(self, h_compose, idx_focal, pos_compose):  #h_compose lei bie te zheng,  pos_compose wei zhi te zheng
        ...
        # print(pos_focal.shape) #l,3
        # print(relative_mu.shape) #l,3,3
...
# Loss 5.443801 | Loss(Fron) 0.150651 | Loss(Pos) 3.373746
